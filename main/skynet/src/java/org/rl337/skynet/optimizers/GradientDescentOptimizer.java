...
public class GradientDescentOptimizer extends AbstractIterativeOptimizer {
    ...
    public GradientDescentOptimizer(double alpha, Hypothesis h, CostFunction c, int maxIterations, double epsilon, boolean debug) {
        super(h, c, maxIterations, epsilon, debug);
        mAlpha = alpha;
    }

    
    public GradientDescentOptimizer(double alpha, Hypothesis h, CostFunction c, int maxIterations, double epsilon) {
